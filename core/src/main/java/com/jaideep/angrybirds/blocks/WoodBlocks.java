...
public class WoodBlocks extends Blocks implements BlockInterface {
    public static transient Texture blockTexture;
    
    public WoodBlocks(Body body, Sprite sprite) {
        super(body, sprite);
    }
    
    
    public static Blocks createWoodBlock(float x, float y, boolean isHori, World world) {
        // Load the block texture
        blockTexture = new Texture("blocks/WoodBlock.jpg");
        ...
        fixtureDef.density = 2.5f; // Increased density for stability
        fixtureDef.friction = 1.5f; // Higher friction for better interaction
